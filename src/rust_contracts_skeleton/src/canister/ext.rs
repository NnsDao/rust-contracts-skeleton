...
struct File { data: Vec<Vec<u8>>, ctype: String }
...
#[derive(CandidType, Deserialize)]
enum User { principal(candid::Principal), address(AccountIdentifier) }

#[derive(CandidType, Deserialize)]
struct BalanceRequest { token: TokenIdentifier, user: User }

type Balance = candid::Nat;
#[derive(CandidType, Deserialize)]
enum CommonError__1 { InvalidToken(TokenIdentifier), Other(String) }

#[derive(CandidType, Deserialize)]
enum BalanceResponse { ok(Balance), err(CommonError__1) }

type TokenIdentifier__1 = String;
#[derive(CandidType, Deserialize)]
enum CommonError { InvalidToken(TokenIdentifier), Other(String) }

#[derive(CandidType, Deserialize)]
enum Result_7 { ok(AccountIdentifier__1), err(CommonError) }

type Time = candid::Int;
#[derive(CandidType, Deserialize)]
struct Listing { locked: Option<Time>, seller: candid::Principal, price: u64 }

#[derive(CandidType, Deserialize)]
enum Result_8 { ok(AccountIdentifier__1,Option<Listing>,), err(CommonError) }

type Extension = String;

#[derive(CandidType, Deserialize)]
enum Result_4 { ok, err(String) }
...
#[derive(CandidType, Deserialize)]
enum Result_3 { ok, err(CommonError) }
...
#[derive(CandidType, Deserialize)]
enum Result_6 { ok(Metadata), err(CommonError) }

#[derive(CandidType, Deserialize)]
enum Result_5 { ok(AccountIdentifier__1,u64,), err(String) }
...
#[derive(CandidType, Deserialize)]
enum Result_2 { ok(Balance__1), err(CommonError) }

#[derive(CandidType, Deserialize)]
enum Result_1 { ok(Vec<TokenIndex>), err(CommonError) }
...
#[derive(CandidType, Deserialize)]
enum TransferResponse { ok(Balance), err(TransferResponse_err) }
...
impl SERVICE{
  ...
  pub async fn allPayments(&self) -> CallResult<
    (Vec<(candid::Principal,Vec<SubAccount__1>,)>,)
  > { ic_cdk::call(self.0, "allPayments", ()).await }
  pub async fn allSettlements(&self) -> CallResult<
    (Vec<(TokenIndex,Settlement,)>,)
  ...
  pub async fn balance(&self, arg0: BalanceRequest) -> CallResult<
    (BalanceResponse,)
  > { ic_cdk::call(self.0, "balance", (arg0,)).await }
  pub async fn bearer(&self, arg0: TokenIdentifier__1) -> CallResult<
    (Result_7,)
  ...
  pub async fn details(&self, arg0: TokenIdentifier__1) -> CallResult<
    (Result_8,)
  ...
  pub async fn failedSales(&self) -> CallResult<
    (Vec<(AccountIdentifier__1,SubAccount__1,)>,)
  ...
  pub async fn getRegistry(&self) -> CallResult<
    (Vec<(TokenIndex,AccountIdentifier__1,)>,)
  ...
  pub async fn listings(&self) -> CallResult<
    (Vec<(TokenIndex,Listing,Metadata,)>,)
  ...
  pub async fn metadata(&self, arg0: TokenIdentifier__1) -> CallResult<
    (Result_6,)
  ...
  pub async fn retreive(&self, arg0: AccountIdentifier__1) -> CallResult<
    (Result_4,)
  ...
  pub async fn salesSettlements(&self) -> CallResult<
    (Vec<(AccountIdentifier__1,Sale,)>,)
  > { ic_cdk::call(self.0, "salesSettlements", ()).await }
  pub async fn salesStats(&self, arg0: AccountIdentifier__1) -> CallResult<
    (Time,u64,candid::Nat,)
  ...
  pub async fn stats(&self) -> CallResult<
    (u64,u64,u64,u64,candid::Nat,candid::Nat,candid::Nat,)
  > { ic_cdk::call(self.0, "stats", ()).await }

  pub async fn supply(&self) -> CallResult<(Result_2,)> {
    ic_cdk::call(self.0, "supply", ()).await
  }
  pub async fn tokens(&self, arg0: AccountIdentifier__1) -> CallResult<
    (Result_1,)
  > { ic_cdk::call(self.0, "tokens", (arg0,)).await }
  pub async fn tokens_ext(&self, arg0: AccountIdentifier__1) -> CallResult<
    (Result,)
  ...
  pub async fn transfer(&self, arg0: TransferRequest) -> CallResult<
    (TransferResponse,)
